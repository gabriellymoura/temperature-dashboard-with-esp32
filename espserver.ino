...
#define FIREBASE_HOST "https://teste-final-esp-default-rtdb.firebaseio.com/"
#define FIREBASE_AUTH "sBRpKVCxuNtJD1xrbvN8YV1jdrH8TZDuRylcLV8V"

const char* ssid = "Moura";
const char* password = "1q2w3r4t";
